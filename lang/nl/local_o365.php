...
$string['erroracpnosptoken'] = 'Heb geen beschikbare SharePoint-token en kan er geen krijgen.';
...
$string['errorcreatingsharepointclient'] = 'Kan geen SharePoint-API-client verkrijgen';
...
$string['errorcouldnotcreatespgroup'] = 'Kan de SharePoint-groep niet maken.';
...
$string['healthcheck_systemtoken_result_notoken'] = 'Moodle heeft geen token om als systeem-API-gebruiker met Office&nbsp;365 te communiceren. Dit probleem kan doorgaans worden opgelost door de systeem-API-gebruiker te resetten.';
$string['healthcheck_systemtoken_result_noclientcreds'] = 'Er zijn geen toepassingsreferenties in de OpenID Connect-plugin. Zonder deze referenties kan Moodle niet met Office&nbsp;365 communiceren. Klik hier om de instellingenpagina te openen en je referenties in te voeren.';
...
$string['settings_detectoidc_details'] = 'Voor de communicatie met Office&nbsp;365 heeft Moodle referenties nodig om zichzelf te identificeren. Deze zijn ingesteld in de authenticatie-plugin OpenID Connect.';
...
$string['settings_enableunifiedapi'] = 'Unified API inchakelen';
$string['settings_enableunifiedapi_details'] = 'De Unified API is een voorbeeld-API die een aantal nieuwe functies biedt zoals de instelling "Gebruikersgroepen maken" hieronder. Hij zal uiteindelijk de toepassingsspecifieke Office API\'s vervangen. Unified API is echter nog steeds een voorbeeld en kan worden gewijzigd waardoor sommige functies verloren kunnen gaan. Als je hem uit wilt proberen, schakel je deze instelling in en klik je op \'Wijzigingen opslaan\'. Voeg de \'Unified API\' toe aan je toepassing in Azure en kom daarna hier terug en voer de onderstaande tool "Azure Setup" uit.';
...
$string['settings_sharepointlink'] = 'SharePoint-koppeling';
$string['settings_sharepointlink_error'] = 'Er is een probleem opgetreden bij het instellen van SharePoint. <br /><br /><ul><li>Als je foutopsporingslogboeken hebt ingeschakeld (de instelling \'Foutopsporingsberichten registreren\' hierboven), is er mogelijk meer informatie beschikbaar in het Moodle-logboekrapport. (Sitebeheer > Rapporten > Logboeken).</li><li>Als je opnieuw wilt proberen in te stellen, klik je op "Site wijzigen", kies je een nieuwe SharePoint-site, klik je onder aan deze pagina op "Wijzigingen opslaan" en voer je de Moodle-cron uit.</ul>';
$string['settings_sharepointlink_connected'] = 'Moodle is verbonden met deze SharePoint-site.';
...
$string['settings_sharepointlink_status_checking'] = 'Ingevoerde SharePoint-site wordt gecontroleerd...';
...
$string['task_groupcreate'] = 'Gebruikersgroepen maken in Office&nbsp;365';
...
$string['task_sharepointinit'] = 'Initialiseer SharePoint.';
...
$string['ucp_connection_status'] = 'Office&nbsp;365-verbinding is:';
$string['ucp_connection_start'] = 'Verbinding maken met Office&nbsp;365';
$string['ucp_connection_stop'] = 'Verbinding met Office&nbsp;365 verbreken';
$string['ucp_features'] = 'Office&nbsp;365-functies';
$string['ucp_features_intro'] = 'Hieronder vind je een lijst met functies waarmee je Moodle met Office&nbsp;365 kunt verbeteren.';
$string['ucp_features_intro_notconnected'] = 'Enkele daarvan zijn misschien pas beschikbaar wanneer je bent verbonden met Office&nbsp;365.';
$string['ucp_general_intro'] = 'Hier kun je de verbinding met Office&nbsp;365 beheren.';
$string['ucp_index_aadlogin_title'] = 'Office&nbsp;365-aanmelding';
$string['ucp_index_aadlogin_desc'] = 'Je kunt je Office&nbsp;365-referenties gebruiken om je aan te melden bij Moodle. ';
...
$string['ucp_index_connectionstatus_connected'] = 'Je bent momenteel verbonden met Office&nbsp;365';
$string['ucp_index_connectionstatus_matched'] = 'Je bent gekoppeld aan Office&nbsp;365-gebruiker <small>{$a}</small>. Klik op onderstaande koppeling en meld je aan bij Office&nbsp;365 om deze verbinding te voltooien.';
$string['ucp_index_connectionstatus_notconnected'] = 'Je bent momenteel niet verbonden met Office&nbsp;365';
$string['ucp_index_onenote_title'] = 'OneNote';
$string['ucp_index_onenote_desc'] = 'Met OneNote-integratie kun je Office&nbsp;365 OneNote met Moodle gebruiken. Je kunt opdrachten uitvoeren met OneNote en gemakkelijk notities voor je cursussen maken.';
$string['ucp_notconnected'] = 'Maak eerst verbinding met Office&nbsp;365 voordat je hier naartoe gaat.';
$string['ucp_onenote_title'] = 'OneNote';
$string['ucp_onenote_desc'] = 'Deze pagina bevat opties voor Office&nbsp;365 OneNote.';
$string['ucp_onenote_disable'] = 'Office&nbsp;365 OneNote uitschakelen';
...
$string['ucp_title'] = 'Office&nbsp;365-/Moodle-configuratiescherm';
