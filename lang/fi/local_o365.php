...
$string['settings_enableunifiedapi'] = 'Ota käyttöön yhdistetty ohjelmointirajapinta';
$string['settings_enableunifiedapi_details'] = 'Yhdistetty ohjelmointirajapinta on ennakkovaiheessa oleva ohjelmointirajapinta, joka sisältää uusia ominaisuuksia, kuten alla olevan Luo käyttäjäryhmät -asetuksen. Yhdistetty ohjelmointirajapinta tulee myöhemmin korvaamaan sovelluskohtaiset Office-ohjelmointirajapinnat, mutta tällä hetkellä se on vielä kehityksessä ja sen ominaisuudet voivat vielä muuttua. Jos haluat kokeilla sitä, ota käyttöön tämä asetus ja valitse Tallenna muutokset. Lisää Yhdistetty ohjelmointirajapinta sovellukseesi Azuressa ja palaa sitten tänne suorittamaan alla oleva Azure-määritys-työkalu.';
...
$string['ucp_onenote_desc'] = 'Tällä sivulla on Office&nbsp;365 OneNotea koskevat asetukset.';
$string['ucp_onenote_disable'] = 'Poista käytöstä Office&nbsp;365 OneNote';
