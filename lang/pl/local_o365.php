...
$string['ucp_onenote_title'] = 'Program OneNote';
$string['ucp_onenote_desc'] = 'Ta strona zawiera opcje dla programu OneNote z pakietu Office&nbsp;365.';
$string['ucp_onenote_disable'] = 'Wyłącz program OneNote w pakiecie Office&nbsp;365';
