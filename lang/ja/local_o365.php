...
$string['pluginname'] = 'Microsoft Office 365の統合';
$string['acp_title'] = 'Office&nbsp;365管理コントロールパネル';
...
$string['erroracpnosptoken'] = '利用可能なSharePointトークンがなく、取得することもできませんでした。';
...
$string['healthcheck_systemtoken_result_notoken'] = 'Office&nbsp;365にシステムAPIユーザとして通信するためのトークンをMoodleが持っていません。これは通常、システムAPIユーザをリセットすることで解決します。';
$string['healthcheck_systemtoken_result_noclientcreds'] = 'OpenID Connectプラグインにアプリケーションの認証情報がありません。これらの認証情報がないとMoodleはOffice&nbsp;365と通信できません。ここをクリックして設定ページにアクセスし、認証情報を入力してください。';
...
$string['settings_aadsync_matchswitchauth'] = '一致したユーザをOffice 365 (OpenID Connect) 認証に切り替える<br /><small>ここでは、上の「一致」設定を有効にする必要があります。ユーザが一致する場合、この設定を有効にすると、認証方法がOpenID Connectに切り替わります。その後、Office 365の資格情報を使用してMoodleにログインします。<b>注意: この設定を使用する場合は、OpenID Connect認証プラグインが有効であることを確認してください。</small>';
...
$string['settings_detectoidc_details'] = 'Office&nbsp;365と通信するには、Moodleを識別するための認証情報が必要です。認証情報は"OpenID Connect"認証プラグインに設定されています。';
...
$string['settings_enableunifiedapi'] = '統合APIを有効にする';
$string['settings_enableunifiedapi_details'] = '統合APIとは、以下で設定する「ユーザグループを作成する」のような、いくつかの新しい機能を提供するプレビューAPIのことです。最終的にアプリケーション固有のOffice APIに取って代わりますが、プレビューに残るため、この変更により、いくつかの機能に問題が生じる可能性があります。試してみたい場合は、この設定を有効にして「変更を保存する」をクリックしてください。「統合API」をAzure内のアプリケーションに追加し、ここに戻って、以下の「Azure設定」ツールを実行します。';
...
$string['settings_sharepointlink_error'] = 'SharePointの設定中に問題が発生しました。<br /><br /><ul><li>デバッグのログ記録 (上で設定する「デバッグメッセージを記録する」) を有効にすると、Moodleログレポートでより多くの情報が入手できるようになります (「サイト管理」>「レポート」>「ログ」)。</li><li>設定を再試行するには、「サイトを変更する」をクリックして、新しいSharePointサイトを選択し、このページの下部で「変更を保存する」をクリックし、 Moodle cronを実行します。</ul>';
$string['settings_sharepointlink_connected'] = 'MoodleはこのSharePointサイトに接続されます。';
...
$string['settings_sharepointlink_status_checking'] = '入力したSharePointサイトを確認しています...';
...
$string['ucp_connection_status'] = 'Office&nbsp;365の接続は次のとおりです。';
$string['ucp_connection_start'] = '&nbsp;365に接続する';
$string['ucp_connection_stop'] = 'Office&nbsp;365から接続解除する';
$string['ucp_features'] = 'Office 365の機能';
$string['ucp_features_intro'] = '以下は、Office 365でMoodleを機能強化する際に使用できる機能のリストです。';
$string['ucp_features_intro_notconnected'] = '一部の機能は、Office 365に接続するまで使用できない可能性があります。';
$string['ucp_general_intro'] = 'ここでOffice&nbsp;365への接続を管理できます。';
$string['ucp_index_aadlogin_title'] = 'Office&nbsp;365のログイン';
$string['ucp_index_aadlogin_desc'] = 'Office&nbsp;365の認証情報を使用してMoodleにログインできます。 ';
...
$string['ucp_index_connectionstatus_connected'] = '現在Office&nbsp;365に接続されています';
$string['ucp_index_connectionstatus_matched'] = 'Office 365ユーザ<small>"{$a}"</small>と一致しました。 この接続を完了するには、以下のリンクをクリックしてOffice 365にログインしてください。';
$string['ucp_index_connectionstatus_notconnected'] = '現在Office&nbsp;365に接続されていません';
$string['ucp_index_onenote_title'] = 'OneNote';
$string['ucp_index_onenote_desc'] = 'OneNoteの統合により、Office&nbsp;365 OneNoteをMoodleで使用できます。OneNoteを使用して課題を完成させたり、コースで気軽にメモを取ったりできます。';
$string['ucp_notconnected'] = 'ここにアクセスする前に、Office&nbsp;365に接続してください。';
$string['ucp_onenote_title'] = 'OneNote';
$string['ucp_onenote_desc'] = 'このページでは、Office 365 OneNoteのオプションを提供します。';
$string['ucp_onenote_disable'] = 'Office&nbsp;365 OneNoteを無効にする';
...
$string['ucp_title'] = 'Office&nbsp;365 / Moodleコントロールパネル';
