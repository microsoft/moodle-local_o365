...
$string['pluginname'] = 'Intégration de Microsoft Office 365';
$string['acp_title'] = 'Panneau de configuration d\'administration Office 365';
...
$string['erroracpnosptoken'] = 'Aucun jeton SharePoint disponible. Impossible d\'en obtenir un.';
...
$string['settings_aadsync_match'] = 'Faire correspondre les utilisateurs Moodle pré-existants avec des comptes du même nom dans Azure AD<br /><small>Cette option compare les noms d\'utilisateur dans Office 365 et dans Moodle pour essayer de trouver des correspondances. La recherche ignore la casse et ne tient pas compte du client Office 365. Par exemple, BoB.SmiTh dans Moodle serait associé à l\'adresse bob.smith@example.onmicrosoft.com. Les comptes Moodle et Office des utilisateurs pour lesquels une correspondance est détectée sont connectés et bénéficient de l\'ensemble des fonctions d\'intégration Office 365/Moodle. La méthode d\'authentification de l\'utilisateur ne change pas, sauf si le paramètre ci-dessous est activé.</small>';
$string['settings_aadsync_matchswitchauth'] = 'Utiliser l\'authentification Office 365 (OpenID Connect) pour les utilisateurs associés<br /><small>Pour utiliser cette option, le paramètre de mise en correspondance ci-dessus doit être activé. Quand une correspondance est détectée pour un utilisateur et que cette option est activée, la méthode d\'authentification de cet utilisateur devient OpenID Connect. Il devra alors se connecter à Moodle avec ses informations d\'identification Office 365. <b>Remarque :</b> pour utiliser ce paramètre vérifiez que le plug-in d\'authentification OpenID Connect est activé.</small>';
...
$string['settings_detectoidc_details'] = 'Pour communiquer avec Office 365, Moodle a besoin d\'informations d\'identification pour s\'identifier. Elles sont définies dans le plug-in d\'authentification « OpenID Connect ».';
...
$string['settings_enableunifiedapi'] = 'Activer l\'API unifiée';
$string['settings_enableunifiedapi_details'] = 'L\'API unifiée est une API de prévisualisation qui offre quelques nouvelles fonctions, comme le paramètre « Créer des groupes d\'utilisateurs » ci-dessous. Elle doit à terme remplacer les API Office propres aux applications. Cependant, elle est encore en phase d\'essai et peut faire l\'objet de modifications, lesquelles peuvent entraîner le retrait de certaines fonctionnalités. Pour l\'essayer, activez ce paramètre et cliquez sur « Enregistrer les modifications ». Ajoutez l\'API unifiée à votre application dans Azure, puis revenez sur cette page et exécutez l\'outil « Configuration Azure » ci-dessous.';
...
$string['settings_sharepointlink_error'] = 'Un problème est survenu pendant la configuration de SharePoint. <br /><br /><ul><li>Si l\'enregistrement de débogage est activé (paramètre « Enregistrer les messages de débogage » ci-dessus), des informations supplémentaires sont peut-être disponibles dans le rapport d\'historiques Moodle (Administration du site > Rapports > Historiques).</li><li>Pour réessayer d\'effectuer la configuration, cliquez sur« Modifier le site », choisissez un nouveau site SharePoint, cliquez sur « Enregistrer les modifications » en bas de cette page, puis exécutez le cron Moodle.</ul>';
$string['settings_sharepointlink_connected'] = 'Moodle est connecté à ce site SharePoint.';
$string['settings_sharepointlink_changelink'] = 'Modifier le site';
$string['settings_sharepointlink_initializing'] = 'Moodle configure ce site SharePoint. Cela se produira lors de la prochaine exécution du cron Moodle.';
$string['settings_sharepointlink_enterurl'] = 'Saisissez une URL ci-dessus.';
$string['settings_sharepointlink_details'] = 'Pour connecter Moodle et SharePoint, entrez l\'intégralité de l\'URL d\'un site SharePoint auquel connecter Moodle. En l\'absence de ce site, Moodle tentera de le créer.<br /><a href="https://docs.moodle.org/27/en/Office365/SharePoint">Obtenez plus d\'informations sur la connexion de Moodle et SharePoint</a>';
$string['settings_sharepointlink_status_invalid'] = 'Ceci n\'est pas un site SharePoint utilisable.';
$string['settings_sharepointlink_status_notempty'] = 'Ce site est utilisable, mais il existe déjà. Moodle peut rencontrer un conflit avec le contenu existant. Pour obtenir les meilleurs résultats, indiquez un site SharePoint qui n\'existe pas. Moodle le créera.';
$string['settings_sharepointlink_status_valid'] = 'Moodle créera ce site SharePoint et l\'utilisera pour son contenu.';
$string['settings_sharepointlink_status_checking'] = 'Vérification du site SharePoint indiqué...';
...
$string['ucp_connection_status'] = 'Connexion Office 365 :';
$string['ucp_connection_start'] = 'Se connecter à Office 365';
$string['ucp_connection_stop'] = 'Se déconnecter d\'Office 365';
$string['ucp_features'] = 'Fonctionnalités Office&nbsp;365';
$string['ucp_features_intro'] = 'Voici une liste des fonctionnalités que vous pouvez utiliser pour améliorer Moodle avec Office&nbsp;365.';
$string['ucp_features_intro_notconnected'] = 'Certaines de ces fonctionnalités ne seront peut-être pas disponibles tant que vous ne vous serez pas connecté à Office&nbsp;365.';
$string['ucp_general_intro'] = 'Vous pouvez gérer ici votre connexion à Office 365.';
...
$string['ucp_index_connectionstatus_matched'] = 'Vous avez été mis en correspondance avec un utilisateur Office&nbsp;365 <small>"{$a}"</small>. Pour effectuer cette connexion, cliquez sur le lien ci-dessous et connectez-vous à Office&nbsp;365.';
$string['ucp_index_connectionstatus_notconnected'] = 'Actuellement, vous n\'êtes pas connecté à Office 365';
$string['ucp_index_onenote_title'] = 'OneNote';
$string['ucp_index_onenote_desc'] = 'L\'intégration de OneNote vous permet d\'utiliser Office 365 OneNote avec Moodle. Vous pouvez effectuer des devoirs à l\'aide de OneNote et prendre facilement des notes pour vos cours.';
$string['ucp_notconnected'] = 'Connectez-vous à Office 365 avant d\'accéder à cette page.';
$string['ucp_onenote_title'] = 'OneNote';
$string['ucp_onenote_desc'] = 'Cette page propose des options pour Office 365 OneNote.';
$string['ucp_onenote_disable'] = 'Désactiver Office 365 OneNote';
