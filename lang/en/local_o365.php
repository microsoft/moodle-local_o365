...
$string['acp_userconnections_resync_notconnected'] = 'This user is not connected to Office 365';
$string['acp_userconnections_resync_nodata'] = 'Could not find stored Office 365 information for this user.';
...
$string['privacy:metadata:local_o365_calsub:o365calid'] = 'The ID of the Office 365 calendar';
...
$string['privacy:metadata:local_o365_connections'] = 'Information about connections between Moodle and Office 365 users that have not yet been confirmed';
$string['privacy:metadata:local_o365_connections:muserid'] = 'The ID of the Moodle user';
$string['privacy:metadata:local_o365_connections:aadupn'] = 'The UPN of the Office 365 user.';
...
$string['privacy:metadata:local_o365_token'] = 'Information about Office 365 API tokens for users';
...
$string['privacy:metadata:local_o365_objects'] = 'Information about the relationship between Moodle and Office 365 objects';
...
$string['privacy:metadata:local_o365_objects:objectid'] = 'The Office 365 object id';
$string['privacy:metadata:local_o365_objects:moodleid'] = 'The ID of the object in Moodle';
$string['privacy:metadata:local_o365_objects:o365name'] = 'The human-readable name of the object in Office 365';
...
$string['privacy:metadata:local_o365_spgroupassign:groupid'] = 'The ID of the group in Office 365';
$string['privacy:metadata:local_o365_spgroupassign:timecreated'] = 'The time the record was created';
$string['privacy:metadata:local_o365_appassign'] = 'Information about Office 365 app role assignments';
...
$string['privacy:metadata:local_o365_appassign:photoid'] = 'The ID of the user\'s photo in Office 365';
$string['privacy:metadata:local_o365_appassign:photoupdated'] = 'When the user\'s photo was last updated from Office 365';
$string['privacy:metadata:local_o365_matchqueue'] = 'Information about Moodle user to Office 365 user matching';
$string['privacy:metadata:local_o365_matchqueue:musername'] = 'The username of the Moodle user.';
$string['privacy:metadata:local_o365_matchqueue:o365username'] = 'The username of the Office 365 user.';
...
$string['privacy:metadata:local_o365_calsettings:o365calid'] = 'The ID of the calendar in Office 365';
...
$string['settings_azuresetup_unifieddesc'] = 'The Microsoft Graph API allows communication between Moodle and Office 365.';
...
$string['settings_enableapponlyaccess_details'] = '<b>Recommended</b>. Using this method, the integration accesses Office 365 directly using Azure\'s "Application Permissions". This is the easiest, and recommended way to connect to Office 365, but requires you enable a few extra permissions in Azure.<br /><br /><b>- Or -</b><br />';
...
$string['settings_setup_step3_desc'] = 'This last step allows you to give administrator consent to use some Azure permissions, and gathers some additional information about your Office 365 environment.<br /><br />';
...
$string['settings_teamsprefix'] = 'Prefix for new Teams names';
$string['settings_teamsprefix_desc'] = 'Enter a value here if you want all the Teams names to have a prefix.';
