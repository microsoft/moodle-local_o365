...
$string['erroracpcantgettenant'] = 'Could not get Azure AD tenant, please enter manually.';
...
$string['settings_header_sds'] = 'School Data Sync <sup>preview</sup>';
...
$string['settings_setup_step1_perms'] = '<b>Permissions:</b> Once you have the Application ID and key, you will need to enable the <a href="https://docs.moodle.org/34/en/Office365#Configure_application">Permissions</a> listed in the integration documentation.<br /><br /><br />';
