...
$string['pluginname'] = 'Integração ao Microsoft Office 365';
$string['acp_title'] = 'Painel de controle de administração do Office 365';
...
$string['erroracpnosptoken'] = 'Não possuía um token disponível do SharePoint e não foi possível obter um.';
...
$string['errorcreatingsharepointclient'] = 'Não foi possível obter o cliente da API do SharePoint';
...
$string['errorcouldnotcreatespgroup'] = 'Não foi possível criar o grupo do SharePoint.';
...
$string['healthcheck_systemtoken_result_notoken'] = 'O Moodle não tem um token para se comunicar com o Office 365 como o usuário da API do sistema. Geralmente, isso pode ser resolvido por meio da redefinição do usuário da API do sistema.';
$string['healthcheck_systemtoken_result_noclientcreds'] = 'Não há credenciais de aplicativo presentes no plugin OpenID Connect. Sem essas credenciais, o Moodle não pode se comunicar com o Office 365. Clique aqui para acessar a página de configurações e inserir suas credenciais.';
$string['healthcheck_systemtoken_result_badtoken'] = 'Houve um problema ao se comunicar com o Office 365 como o usuário da API do sistema. Geralmente, isso pode ser resolvido por meio da redefinição do usuário da API do sistema.';
$string['healthcheck_systemtoken_result_passed'] = 'O Moodle pode se comunicar com o Office 365 como o usuário da API do sistema.';
$string['settings_aadsync'] = 'Sincronizar usuários com o AD do Azure';
$string['settings_aadsync_details'] = 'Quando essa configuração estiver ativada, os usuários do Moodle e do AD do Azure serão sincronizados de acordo com as opções acima.<br /><br /><b>Observação: </b>o trabalho de sincronização é executado no cron do Moodle. Por padrão, ele é executado uma vez ao dia, à 1h no fuso horário local do seu servidor. Para sincronizar grandes conjuntos de usuários com mais agilidade, você pode aumentar a frequência da tarefa <b>Sincronizar usuários com o AD do Azure</b> usando a <a href="{$a}">página de gerenciamento de tarefas agendadas.</a><br /><br />Para obter instruções mais detalhadas, consulte a <a href="https://docs.moodle.org/27/en/Office365#User_sync">documentação de sincronização de usuários</a><br /><br />';
...
$string['settings_aadsync_match'] = 'Associar usuários pré-existentes do Moodle a contas de mesmo nome no AD do Azure<br /><small>Essa opção verificará o nome de usuário no Office 365 e o nome de usuário no Moodle e tentará encontrar correspondências. As correspondências não diferenciam letras maiúsculas de minúsculas e ignoram o locatário do Office 365. Por exemplo, o nome de usuário CaRlOs.SilVa do Moodle seria considerado correspondente a carlos.silva@exemplo.onmicrosoft.com. Os usuários com correspondências identificadas terão suas contas do Moodle e do Office conectadas e poderão usar todos os recursos da integração entre Office 365 e Moodle. O método de autenticação dos usuários não será alterado, a menos que a configuração abaixo seja ativada.</small>';
$string['settings_aadsync_matchswitchauth'] = 'Alterar a autenticação dos usuários associados para o Office 365 (OpenID Connect)<br /><small>Essa opção exige que a configuração de correspondência acima esteja ativada. Quando for realizada a correspondência de um usuário, a ativação dessa configuração alterará o método de autenticação dele para o OpenID Connect. Com isso, o usuário poderá fazer login no Moodle com as credenciais do Office 365. <b>Observação:</b> se você quiser usar essa configuração, certifique-se de que o plugin de autenticação do OpenID Connect esteja ativado.</small>';
...
$string['settings_detectoidc_details'] = 'Para se comunicar com o Office 365, o Moodle precisa de credenciais de identificação, que são definidas no plugin de autenticação "OpenID Connect".';
...
$string['settings_enableunifiedapi'] = 'Ativar API unificada';
$string['settings_enableunifiedapi_details'] = 'A API unificada é uma API prévia que oferece alguns recursos novos, como a configuração "Criar grupos de usuários" abaixo. Futuramente, ela substituirá as APIs de aplicativos específicos do Office. No entanto, por ainda se tratar de uma versão prévia, ela está sujeita a mudanças que podem fazer com que alguns recursos deixem de funcionar. Se você deseja testá-la, ative essa configuração e clique em "Salvar alterações". Adicione a "API unificada" ao seu aplicativo no Azure e, em seguida, volte aqui e execute a ferramenta "Configuração do Azure" abaixo.';
...
$string['settings_sharepointlink'] = 'Link do SharePoint';
$string['settings_sharepointlink_error'] = 'Houve um problema ao configurar o SharePoint. <br /><br /><ul><li>Caso você esteja com o registro de depuração ativado (a configuração "Registrar mensagens de depuração" acima), é possível que mais informações estejam disponíveis no relatório de log do Moodle (Administração do site > Relatórios > Logs). </li><li>Para tentar novamente a configuração, clique em "Alterar site", escolha um novo site do SharePoint na parte inferior desta página e execute o cron do Moodle.</ul>';
$string['settings_sharepointlink_connected'] = 'O Moodle está conectado a este site do SharePoint.';
$string['settings_sharepointlink_changelink'] = 'Alterar site';
$string['settings_sharepointlink_initializing'] = 'O Moodle está configurando este site do SharePoint. Isso ocorrerá durante a próxima execução do cron do Moodle.';
$string['settings_sharepointlink_enterurl'] = 'Insira um URL acima.';
$string['settings_sharepointlink_details'] = 'Para conectar o Moodle e o SharePoint, insira o URL completo de um site do SharePoint ao qual deseja que o Moodle se conecte. Caso o site não exista, o Moodle tentará criá-lo.<br /><a href="https://docs.moodle.org/27/en/Office365/SharePoint">Leia mais sobre a conexão entre o Moodle e o SharePoint</a>';
$string['settings_sharepointlink_status_invalid'] = 'Este não é um site utilizável do SharePoint.';
$string['settings_sharepointlink_status_notempty'] = 'Este site pode ser utilizado, mas já existe. Pode haver um conflito do Moodle com o conteúdo existente. Para obter os melhores resultados, insira um site do SharePoint que não exista para que o Moodle o crie.';
$string['settings_sharepointlink_status_valid'] = 'Este site do SharePoint será criado pelo Moodle e usado para conteúdo do Moodle.';
$string['settings_sharepointlink_status_checking'] = 'Verificando o site do SharePoint inserido...';
...
$string['task_groupcreate'] = 'Criar grupos de usuários no Office 365';
...
$string['task_sharepointinit'] = 'Inicializar o SharePoint';
...
$string['ucp_connection_status'] = 'A conexão ao Office 365 está:';
$string['ucp_connection_start'] = 'Conectar-se ao Office 365';
$string['ucp_connection_stop'] = 'Desconectar-se do Office 365';
$string['ucp_features'] = 'Recursos do Office&nbsp;365';
$string['ucp_features_intro'] = 'Veja abaixo uma lista com os recursos que podem ser usados para aprimorar o Moodle com o Office&nbsp;365.';
$string['ucp_features_intro_notconnected'] = 'Alguns desses recursos podem ficar indisponíveis até que você se conecte ao Office&nbsp;365.';
$string['ucp_general_intro'] = 'Aqui você pode gerenciar sua conexão ao Office 365.';
$string['ucp_index_aadlogin_title'] = 'Login no Office 365';
$string['ucp_index_aadlogin_desc'] = 'Você pode usar suas credenciais do Office 365 para fazer login no Moodle. ';
...
$string['ucp_index_connectionstatus_connected'] = 'Você está conectado ao Office 365';
$string['ucp_index_connectionstatus_matched'] = 'Sua conta foi associada ao usuário <small>"{$a}"</small> do Office 365. Para concluir essa conexão, clique no link abaixo e faça login no Office&nbsp;365.';
$string['ucp_index_connectionstatus_notconnected'] = 'Você não está conectado ao Office 365';
$string['ucp_index_onenote_title'] = 'OneNote';
$string['ucp_index_onenote_desc'] = 'A integração ao OneNote permite que você use o Office 365 OneNote com o Moodle. Você pode concluir tarefas usando o OneNote e, com facilidade, fazer anotações sobre seus cursos.';
$string['ucp_notconnected'] = 'Conecte-se ao Office 365 antes de acessar esta página.';
$string['ucp_onenote_title'] = 'OneNote';
$string['ucp_onenote_desc'] = 'Esta página oferece opções para o Office 365 OneNote.';
$string['ucp_onenote_disable'] = 'Desativar o Office 365 OneNote';
...
$string['ucp_title'] = 'Painel de controle do Office 365/Moodle';
