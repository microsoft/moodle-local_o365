...
$string['acp_title'] = 'Office&nbsp;365-Systemsteuerung';
...
$string['erroracpnosptoken'] = 'Kein verfügbares SharePoint-Token vorhanden und es konnte auch kein Token abgerufen werden.';
...
$string['errorcreatingsharepointclient'] = 'SharePoint-API-Client konnte nicht abgerufen werden';
...
$string['errorcouldnotcreatespgroup'] = 'Die SharePoint-Gruppe konnte nicht erstellt werden.';
...
$string['healthcheck_systemtoken_result_notoken'] = 'Moodle besitzt kein Token für die Kommunikation mit Office&nbsp;365 als System-API-Nutzer. Dies kann in der Regel dadurch behoben werden, dass der System-API-Nutzer zurückgesetzt wird.';
$string['healthcheck_systemtoken_result_noclientcreds'] = 'Im OpenID Connect-Plugin sind keine Anwendungsanmeldeinformationen vorhanden. Ohne diese Anmeldeinformationen kann Moodle keine Kommunikation mit Office&nbsp;365 durchführen. Klicken Sie hier, um die Einstellungsseite zu öffnen und Ihre Anmeldeinformationen einzugeben.';
$string['healthcheck_systemtoken_result_badtoken'] = 'Bei der Kommunikation mit Office&nbsp;365 als System-API-Nutzer ist ein Problem aufgetreten. Dies kann in der Regel dadurch behoben werden, dass der System-API-Nutzer zurückgesetzt wird.';
$string['healthcheck_systemtoken_result_passed'] = 'Moodle kann nicht als System-API-Nutzer mit Office&nbsp;365 kommunizieren.';
$string['settings_aadsync'] = 'Benutzer mit Azure AD synchronisieren';
$string['settings_aadsync_details'] = 'Wenn diese Option aktiviert ist, werden Moodle- und Azure AD-Benutzer gemäß der obigen Optionen synchronisiert.<br /><br /><b>Hinweis: </b>Der Synchronisierungsauftrag wird im Moodle-Cron ausgeführt. Er synchronisiert 1.000 Benutzer gleichzeitig. Dieser Vorgang wird standardmäßig einmal täglich um 01:00 Uhr in der Zeitzone Ihres Servers ausgeführt. Um große Benutzermengen schneller zu synchronisieren, können Sie die Häufigkeit der Aufgabe <b>Benutzer mit Azure AD synchronisieren</b> mithilfe der Seite für die <a href="{$a}">Verwaltung geplanter Aufgaben erhöhen.</a><br /><br />Ausführlichere Anweisungen finden Sie in der <a href="https://docs.moodle.org/27/en/Office365#User_sync">Dokumentation zur Benutzersynchronisierung</a><br /><br />';
...
$string['settings_aadsync_match'] = 'Vorhandene Moodle-Nutzer mit gleichnamigen Konten in Azure AD vergleichen<br /><small>Hierbei werden die Nutzernamen in Office 365 und Moodle miteinander verglichen, um Übereinstimmungen zu finden. Bei Übereinstimmungen wird die Groß- und Kleinschreibung nicht beachtet und der Office 365-Mandant ignoriert. Beispielsweise stimmt "BeN.SchmidT" in Moodle mit "ben.schmidt@example.onmicrosoft.com" überein. Die Moodle- und Office-Konten von Nutzern, für die eine Übereinstimmung festgestellt wird, werden miteinander verknüpft, sodass alle Office 365- und Moodle-Integrationsfunktionen verwendet werden können. Die Authentifizierungsmethode des Nutzers ändert sich nicht, es sei denn, die nachfolgende Einstellung ist aktiviert.</small>';
$string['settings_aadsync_matchswitchauth'] = 'Wechsel der Authentifizierung abgestimmter Nutzer zu Office 365 (OpenID Connect)<br /><small>Hierzu muss die obige Vergleichseinstellung aktiviert sein. Wenn ein Nutzer abgestimmt wird, ändert sich die Authentifizierungsmethode durch die Aktivierung dieser Einstellung zu OpenID Connect. Der Nutzer meldet sich dann mit seinen Office 365-Anmeldeinformationen bei Moodle an. <b>Hinweis:</b> Stellen Sie sicher, dass das OpenID Connect-Authentifizierungs-Plugin aktiviert ist, wenn Sie diese Einstellung verwenden möchten.</small>';
...
$string['settings_azuresetup_legacydesc'] = 'Die Office&nbsp;365-API besteht aus anwendungsspezifischen APIs.';
$string['settings_azuresetup_legacyerror'] = 'Fehler beim Überprüfen der Office&nbsp;365-API-Einstellungen.';
$string['settings_creategroups'] = 'Benutzergruppen erstellen';
$string['settings_creategroups_details'] = 'Wenn diese Option aktiviert ist, wird für jeden Kurs auf der Website in Office&nbsp;365 eine Gruppe mit Trainern und Teilnehmern erstellt und verwaltet. Dadurch werden bei jeder Cron-Ausführung alle erforderlichen Gruppen erstellt (und alle aktuellen Mitglieder hinzugefügt). Anschließend wird die Gruppenmitgliedschaft verwaltet, während die Nutzer für Moodle-Kurse registriert werden bzw. ihre Registrierung aufgehoben wird.<br /><b>Hinweis: </b>Diese Funktion erfordert, dass die Unified API von Office&nbsp;365 zur Anwendung hinzugefügt wird, die in Azure hinzugefügt wurde. <a href="https://docs.moodle.org/27/en/Office365#User_groups">Setup-Anweisungen und Dokumentation.</a>';
$string['settings_o365china'] = 'Office&nbsp;365 für China';
$string['settings_o365china_details'] = 'Lesen Sie diese Informationen, wenn Sie Office&nbsp;365 für China verwenden.';
...
$string['settings_detectoidc_details'] = 'Moodle benötigt Anmeldeinformationen, um sich für die Kommunikation mit Office&nbsp;365 selbst zu identifizieren. Diese sind im Authentifizierungs-Plugin "OpenID Connect" festgelegt.';
...
$string['settings_enableunifiedapi'] = 'Unified API aktivieren';
$string['settings_enableunifiedapi_details'] = 'Die Unified API ist eine Vorschau-API mit einigen neuen Funktionen wie der Einstellung "Nutzergruppen erstellen" unten. Sie soll die anwendungsspezifischen Office-APIs ersetzen, befindet sich jedoch noch im Vorschaustadium und kann jederzeit geändert werden, sodass einige Funktionen möglicherweise nicht ordnungsgemäß ausgeführt werden. Wenn Sie sie testen möchten, aktivieren Sie diese Einstellung, und klicken Sie auf "Änderungen speichern". Fügen Sie die Unified API Ihrer Anwendung in Azure hinzu, und kehren Sie dann hierher zurück, um das Azure-Setup-Werkzeug unten auszuführen.';
...
$string['settings_sharepointlink_error'] = 'Beim Einrichten von SharePoint ist ein Problem aufgetreten. <br /><br /><ul><li>Wenn Sie die Debug-Protokollierung aktiviert haben (Einstellung "Debugmeldungen aufzeichnen" oben), sind möglicherweise weitere Informationen im Moodle-Protokollbericht verfügbar (Seiten-Administration > Berichte > Protokolle).</li><li>Um das Setup zu wiederholen, klicken Sie auf "Website ändern", wählen Sie eine neue SharePoint-Website, klicken Sie auf "Änderungen speichern" unten auf dieser Seite, und führen Sie Moodle-Cron aus.</ul>';
$string['settings_sharepointlink_connected'] = 'Moodle ist mit dieser SharePoint-Website verbunden.';
$string['settings_sharepointlink_changelink'] = 'Website ändern';
$string['settings_sharepointlink_initializing'] = 'Moodle richtet diese SharePoint-Website ein. Dies wird während der nächsten Ausführung von Moodle-Cron durchgeführt.';
$string['settings_sharepointlink_enterurl'] = 'Geben Sie oben eine URL ein.';
$string['settings_sharepointlink_details'] = 'Geben Sie zum Verbinden von Moodle und SharePoint eine vollständige URL einer SharePoint-Website für Moodle ein, mit der die Verbindung hergestellt werden soll. Wenn die Website nicht vorhanden ist, versucht Moodle, diese zu erstellen.<br /><a href="https://docs.moodle.org/27/en/Office365/SharePoint">Weitere Informationen zum Verbinden von Moodle und SharePoint</a>';
$string['settings_sharepointlink_status_invalid'] = 'Dies ist keine verwendbare SharePoint-Website.';
$string['settings_sharepointlink_status_notempty'] = 'Diese Website kann verwendet werden, ist aber bereits vorhanden. Es können Konflikte zwischen Moodle und dem vorhandenen Inhalt auftreten. Geben Sie eine nicht vorhandene SharePoint-Website ein, die von Moodle erstellt wird, um optimale Ergebnisse zu erhalten.';
$string['settings_sharepointlink_status_valid'] = 'Diese SharePoint-Website wird von Moodle erstellt und für Moodle-Inhalte verwendet.';
$string['settings_sharepointlink_status_checking'] = 'Eingegebene SharePoint-Website wird überprüft...';
...
$string['task_calendarsyncin'] = 'Office 365-Ereignisse mit Moodle synchronisieren';
$string['task_groupcreate'] = 'Nutzergruppen in Office&nbsp;365 erstellen';
...
$string['task_sharepointinit'] = 'Initialisieren Sie SharePoint.';
...
$string['ucp_connection_status'] = 'Die Office&nbsp;365-Verbindung ist:';
$string['ucp_connection_start'] = 'Mit Office&nbsp;365 verbinden';
$string['ucp_connection_stop'] = 'Verbindung mit Office&nbsp;365 trennen';
$string['ucp_features'] = 'Office&nbsp;365-Funktionen';
...
$string['ucp_features_intro_notconnected'] = 'Einige dieser Funktionen sind möglicherweise nicht verfügbar, bevor Sie die Verbindung mit Office&nbsp;365 hergestellt haben.';
$string['ucp_general_intro'] = 'Hier können Sie Ihre Verbindung mit Office&nbsp;365 verwalten.';
$string['ucp_index_aadlogin_title'] = 'Office&nbsp;365-Anmeldung';
$string['ucp_index_aadlogin_desc'] = 'Sie können sich mit Ihren Office&nbsp;365-Anmeldeinformationen bei Moodle anmelden. ';
...
$string['ucp_index_connectionstatus_connected'] = 'Sie sind derzeit mit Office&nbsp;365 verbunden';
$string['ucp_index_connectionstatus_matched'] = 'Sie wurden mit Office&nbsp;365-Benutzer <small>"{$a}" zusammengeführt. Klicken Sie auf den nachfolgenden Link, und melden Sie sich bei Office&nbsp;365 an, um diese Verbindung herzustellen.';
$string['ucp_index_connectionstatus_notconnected'] = 'Sie sind derzeit nicht mit Office&nbsp;365 verbunden';
$string['ucp_index_onenote_title'] = 'OneNote';
$string['ucp_index_onenote_desc'] = 'Die OneNote-Integration ermöglicht die Verwendung von Office&nbsp;365 OneNote mit Moodle. Sie können Zuweisungen mithilfe von OneNote abschließen und problemlos Notizen zu Ihren Kursen machen.';
$string['ucp_notconnected'] = 'Stellen Sie zunächst die Verbindung mit Office&nbsp;365 her, bevor Sie dies öffnen.';
$string['ucp_onenote_title'] = 'OneNote';
$string['ucp_onenote_desc'] = 'Diese Seite stellt Optionen für Office&nbsp;365 OneNote bereit.';
$string['ucp_onenote_disable'] = 'Office&nbsp;365 OneNote deaktivieren';
...
$string['ucp_title'] = 'Office&nbsp;365/Moodle-Systemsteuerung';
